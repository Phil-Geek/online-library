...
document.writeln("            <a href=\'#\' id=\'rightSideCart\'><img src=\'../img/core-img/user.svg\' alt=\'\'></a>");
document.writeln("        </div>");
document.writeln("");
...
document.writeln("                        <img src=\'../img/product-img/product-1.jpg\' class=\'cart-thumb\' alt=\'\'>");
...
document.writeln("                    <a onclick=\'clickLogin()\' class=\'btn essence-btn\' id='myLogin'>登录</a>");
document.writeln("                </div>");
document.writeln("            </div>");
document.writeln("        </div>");
document.writeln("    </div>");
