...
document.writeln("                <a class=\'nav-brand\' href=\'../../index.html\'><img src=\'../img/core-img/logo.png\' alt=\'\'></a>");
...
document.writeln("                                        <img src=\'../img/bg-img/bg-6.jpg\' alt=\'\'>");
document.writeln("                                    </div>");
document.writeln("                                </div>");
document.writeln("                            </li>");
...
document.writeln("                    <form action='./shop.html'>");
...
document.writeln("                    <a href=\'#\' id=\'essenceCartBtn\'><img src=\'../img/core-img/user.svg\' alt=\'\'></a>");
document.writeln("                </div>");
document.writeln("            </div>");
document.writeln("");
document.writeln("        </div>");
...
function enCodeUrl(bookClass) {
    window.location.href=encodeURI("shop.html?bookClass="+bookClass);
}
function code() {
    ...
    window.location.href=encodeURI("shop.html?search="+bookName);
}